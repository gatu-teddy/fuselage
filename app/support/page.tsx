...
export default function SupportPage() {
  return (
    <div style={{ backgroundColor: c.bg, minHeight: "100vh", fontFamily: "Inter, sans-serif", padding: "60px 20px" }}>
          ...
          {[
            {
              ...
              href: "mailto:support@fuselage.io",
              label: "support@fuselage.io",
            },
            {
              icon: MessageCircle,
              title: "Logistics enquiries",
              body: "Shipping timelines, port queries, and tracking assistance.",
              href: "mailto:logistics@fuselage.io",
              label: "logistics@fuselage.io",
            },
