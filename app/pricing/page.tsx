  ...
  return (
    <div style={{ backgroundColor: c.bg, fontFamily: "Inter, sans-serif", minHeight: "100vh" }}>
      ...
      <nav style={{ backgroundColor: c.surface, borderBottom: `1px solid ${c.border}`, position: "sticky", top: 0, zIndex: 50 }}>
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 h-16 flex items-center justify-between relative">
          ...
          <div className="hidden md:flex items-center gap-7">
            {[
              ...
              <Link key={label} href={href} style={{ color: href === "/pricing" ? c.primary : c.muted, fontWeight: href === "/pricing" ? 700 : 500, fontSize: "14px", textDecoration: "none" }}>
                {label}
              </Link>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                a: "Enterprise sellers accept full responsibility for delivery and handling to any destination they add without prior shipment proof. Fuselage is an introduction platform and does not handle goods.",
              },
              {
