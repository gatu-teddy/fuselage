...
// ─── Shared apply signature ───────────────────────────────────────────────────
type ApplyFn = (overrides?: Record<string, string>) => void;
...
function SearchBar({ q, setQ, apply, onApply }: SearchBarProps) {
  return (
...
interface FilterBodyProps {
  steering: string;       setSteering: (v: string) => void;
  availability: string;   setAvailability: (v: string) => void;
  make: string;           setMake: (v: string) => void;
  makeSearch: string;     setMakeSearch: (v: string) => void;
